...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	// our own method with our own exception respsonse details
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		CustomExceptionResponse customExceptionResponse = new CustomExceptionResponse(new Date(), "validation faild", ex.getBindingResult().toString());
		return new ResponseEntity(customExceptionResponse,HttpStatus.NOT_FOUND);
	}
